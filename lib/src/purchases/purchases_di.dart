...
import 'package:karate_stars_app/src/purchases/data/purchases_inapp_repository.dart';
...
void initBlocAndUseCases() {
  getIt.registerFactory(() =>
      PurchasesBloc(getIt(), getIt(), getIt(), getIt(), getIt(), getIt()));

  getIt.registerLazySingleton(() => IsStoreAvailableUseCase(getIt()));
